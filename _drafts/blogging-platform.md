...
Then, just about the time you get frightened by the technical necessities, apps like [Forestry](https://app.forestry.io/) step in and give you a free WYSIWYG front end where you can write a post almost exactly like you would in WordPress making the process crazy simple.